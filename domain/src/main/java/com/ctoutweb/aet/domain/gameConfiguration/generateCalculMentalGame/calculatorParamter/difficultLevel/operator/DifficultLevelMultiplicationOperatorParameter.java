...
public class DifficultLevelMultiplicationOperatorParameter {
public static final IMinAndMax<Integer> MIN_AND_MAX_NUMBER = MENTAL_CALCUL_INSTANCE_PROVIDER.provideMinAndMaxInstance(2, 10);

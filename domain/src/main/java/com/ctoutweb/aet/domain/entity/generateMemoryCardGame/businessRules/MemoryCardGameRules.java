package com.ctoutweb.aet.domain.entity.generateMemoryCardGame.businessRules;
...
import com.ctoutweb.aet.domain.entity.generateMemoryCardGame.impl.gameTextImpl.EndLevelParameterLoader;
...
import com.ctoutweb.aet.domain.usecase.base.RuleBase;
...
public class MemoryCardGameRules extends RuleBase {
  private final IGenerateMemoryCardGameGateway portMemoryCardService;
  ...
  public IGenerateMemoryCardGameOutput getCardGameData() {
    IGenerateMemoryCardGameOutput memoryCardData = MEMORY_CARD_DOMAIN_MODEL_INSTANCE_PROVIDER.provideMemoryCardDataImpl(memoryCardSetter);

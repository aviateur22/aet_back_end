...
public class OperationGeneratedInformation {
    private List<Integer> generatedOperands;
    private List<OperatorType> generatedOperators;
    ...
    public List<OperatorType> getGeneratedOperators() {
        return generatedOperators;
    }

    public void setGeneratedOperators(List<OperatorType> generatedOperators) {
        this.generatedOperators = generatedOperators;
    }
}
